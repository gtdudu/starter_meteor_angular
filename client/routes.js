...
function config($urlRouterProvider, $stateProvider, $locationProvider) {
   ...
   $stateProvider
       .state('staticPage', {
          url: '/static',
          templateUrl: 'client/layout/static/example.html',
       })
      .state('postList', {
         url: '/post/list',
         templateUrl: 'client/layout/post/views/list.html',
         controller: 'PostListCtrl'
      })
      .state('postCreate', {
         url: '/post/create',
         templateUrl: 'client/layout/post/views/create.html',
         controller: 'PostCreateCtrl'
      })
      .state('postView', {
         url: '/post/view/:id',
         templateUrl: 'client/layout/post/views/view.html',
